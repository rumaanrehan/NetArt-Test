...
const MidBody = () => {
  return (
    ...
    <div className='body'>
        ...
        <div className="img-foot">Valves-Pumps-IoT Drives & Controllers-Wires & Cables-Solar Systems-Motors</div>
        <div className="horizontal-line"></div>
        <div>
            <b><p>C.R.I. FLUID SYSTEMS PRODUCTS CATER TO DIVERSE SEGMENTS</p></b>
            <p>CHEMICALS & PROCESS | POWER | WATER &WASTE WATER | OIL & GAS | PHARMA SUGAR & DISTILLERIES | PAPER AND PULP | MARINE & DEFENCE | METAL & MINING | FOOD & BEVERAGE | 
                PETROCHEMICAL & REFINERIES | SOLAR | BUILDING | HVAC | FIRE FIGHTING | AGRICULTURE AND RESIDENTIAL
            </p>
        </div>
    </div>
    </>
